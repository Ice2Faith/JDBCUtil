...
public class DBResultData{
     ...
     */
    public<T> List<T> parserBeans(Class<T> clazz,boolean ignoreCase) throws UtilException {
     ...
     * @return 返回满足要求的对象列表
     */
    public<T> List<T> parserBeans(Class<T> clazz,Map<String,String> attrColMapping,boolean ignoreCase) throws UtilException {
        List<T> ret=new ArrayList<>();
        try{
            //获取所有对象属性
            Field[] fields=clazz.getDeclaredFields();
